...
class TransactionSelectSerializers(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        ...
        if instance.operation == 'long' and instance.broker.broker != 'alpaca':
            profit = (price * instance.qty_open) - \
                (instance.price_open * instance.qty_open)
            current_price = (instance.price_open + profit)
            profit_percentage = (
                current_price - instance.price_open) / instance.price_open
            ...
            profit_percentage = (instance.base_cost -
